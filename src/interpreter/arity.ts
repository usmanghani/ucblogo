...
export const PRIMITIVE_ARITY: Record<string, number> = {
  ...
  PR: 1, TT: 1, TURTLETEXT: 1, SETW: 1, SETWIDTH: 1, SETFONT: 1,
  STAMPRECT: 2, STAMPOVAL: 2, SETVELOCITY: 1, PLAY: 1, MASTERPIECE: 1,
  WAIT: 1, PX: 0, FS: 0, GOHOME: 0, IGNORE: 1, ALERT: 1, SETTS: 1,
  ASK: 2, TELL: 1,
  ...
  // --- Workspace ---
  LOCAL: 1, MAKE: 2, NAME: 2, THING: 1, BURY: 1, BURIED: 1, BURIEDP: 1, BURYALL: 0,
